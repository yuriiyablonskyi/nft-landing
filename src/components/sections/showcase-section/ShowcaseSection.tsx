  ...
  <section>
    <Container>
      <div className={styles.wrapper}>
        <SectionHeader title="Discover More NFTs" subtitle="Explore new trending NFTs" />
              ...
              <div className={styles.showcaseList__info}>
                ...
                <div className={styles.сostWrapper}>
                  <div className={styles.сostWrapper__price}>
                    <p className={styles.сostWrapper__label}>Price</p>
                    <p className={styles.сostWrapper__value}>{price}</p>
                  </div>
                  <div className={styles.сostWrapper__highestBid}>
                    <p className={styles.сostWrapper__labelRight}>Highest Bid</p>
        ...
        <div className={styles.buttonCenter}>
          <Button icon={EyeIcon} text="See All" />
        </div>
      </div>
    </Container>
  </section>
